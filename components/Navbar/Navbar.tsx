			...
			<div className="flex gap-x-4 items-center">
				...
				<SignedOut>
					...
					<Link href="/sign-up" className=" tracking-tighter">
						<Button className="lg:mx-2 w-full group mx-1" size="sm">
							<span className="lg:mr-2 mr-1">Join the Club</span>
							<svg className="group-hover:translate-x-2 duration-200 max-w-[22px] hidden lg:flex" width={27} height={14} viewBox="0 0 27 14" fill="none" xmlns="http://www.w3.org/2000/svg">
